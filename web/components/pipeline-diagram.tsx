 ...
 *   Hevy CSV (import) → Map exercises (N built-in mappings) → Generate FIT
...
const STAGES: Stage[] = [
  { key: "hevy", x: 8, w: 188, title: "Hevy CSV", sub: "Your imported export", cls: "pl-teal", titleVar: "var(--color-teal-light)" },
    ...
    <section className="mb-8 hidden rounded-xl border border-border bg-surface-elevated p-4 md:block">
      ...
      <div className="overflow-x-auto">
        <svg
          viewBox="0 0 852 352"
          role="img"
          aria-label="A workout from the Hevy CSV import is read, exercises are mapped to Garmin FIT categories, a FIT file is generated with heart-rate and calories, and it is uploaded to Garmin. In a loop, Garmin's daily heart-rate is matched to the workout and its calories are computed, feeding back into the FIT."
